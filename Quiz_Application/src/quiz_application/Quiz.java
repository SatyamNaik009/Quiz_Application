...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name)
    {
       ...
       heading1=new JLabel();
       heading1.setBounds(150,450,900,30);
       heading1.setFont(new Font("Tahoma",Font.PLAIN,24));
       add(heading1);
       ...
       /* JButton next=new JButton("Next");
        ...
        next1=new JButton("Submit");
        next1.setBounds(1100,630,200,40);
        next1.setFont(new Font("Tahoma",Font.PLAIN,22));
    ...
    {
        heading.setText(""+(count+1)+". ");
        heading1.setText(questions[count][0]);
